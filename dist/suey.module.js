...
const _changeEvent$2 = new Event('change', { 'bubbles': true, 'cancelable': true });
        ...
        function boxKeyDown(event) {
            ...
            switch (event.key) {
                ...
                case 'ArrowUp':
                    ...
                    if (self.dom) self.dom.dispatchEvent(_changeEvent$2);
                    break;
                case 'ArrowDown':
                    event.preventDefault();
                    self.setValue(self.getValue() - self.nudge);
...
class Slider extends Div {
    constructor(number = 0, min = 0, max = 100) {
        ...
        function sliderWheel(event) {
            ...
            self.setValue(newValue);
            slider.dom.dispatchEvent(_changeEvent$1);
        }
