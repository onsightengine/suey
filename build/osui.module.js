...
class Node extends Div {
    ...
    createHeader(text = '', iconUrl, addToContents = true) {
        ...
        header.boxShadow = new Div().setClass('NodeHeaderBoxShadow');
        header.add(header.iconHolder, header.textHolder, header.boxShadow);
    ...
    applyColor(color) {
        ...
        if (this.header) {
            this.header.setStyle('background-image', `linear-gradient(to bottom, rgba(${colorLight}, 0.5), rgba(${colorDark}, 0.5))`);
        }
    }
}
