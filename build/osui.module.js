...
class TabButton extends Div {
    constructor(parent, label, options = {}) {
        ...
        if (this.iconVector.img && shadow !== false) {
            _color$2.set(shadow);
            const dropShadow = `drop-shadow(var(--minus) var(--pixel) var(--pad-micro) rgba(${_color$2.rgbString()}, 0.75))`;
