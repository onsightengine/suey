...
class MainWindow extends Panel {
    ...
    clearWindows() {
        const windows = Dom.childrenWithClass(this, 'suey-window', true , false );
        this.remove(...windows);
    }
    clearFloaters() {
        this.clearDocks();
