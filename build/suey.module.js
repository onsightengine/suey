...
class Docker2 extends Panel {
    ...
    addDock(side = DOCK_SIDES.LEFT, size = '20%') {
        ...
        Interaction.makeResizeable(dock, resizerDown, resizerMove).addResizers(this.wantsResizer(side), true );
        function resizeTwin() {
    ...
    removeDock() {
        ...
        if (childTabbed) parent.addResizers(parent.wantsResizer(parent.dockSide), true );
        for (const child of parent.children) {
            if (child.hasClass('suey-tabbed')) {
